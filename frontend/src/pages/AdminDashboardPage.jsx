...
// NUEVA PÁGINA: Muestra las estadísticas principales del sistema.
    ...
    <div>
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <StatCard title="Total de Usuarios" value={stats.total_users} icon={icons.users} colorClass="bg-blue-500" />
          <StatCard title="Usuarios Activos" value={stats.active_users} icon={icons.active} colorClass="bg-green-500" />
          <StatCard title="Total de Cotizaciones" value={stats.total_cotizaciones} icon={icons.quotes} colorClass="bg-purple-500" />
          <StatCard title="Nuevos Usuarios (30d)" value={stats.new_users_last_30_days} icon={icons.newUser} colorClass="bg-yellow-500" />
        </div>
      )}
    </div>
  );
